      ...
      <div class="w-full max-w-lg">
        ...
        <input
          ...
          <button className='mx-2' type='button' onClick={() => {
            ...
            <button
            type="submit"
            className="sm:mt-3 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
          >
            Search
          </button>
